                    ...
                    ?>
                        ...
                        <div id="update-form">
                            <form method="POST" action="<?= $base_url; ?>" enctype="multipart/form-data">
                                ...
                                <input type="hidden" value="<?= $obj->getId(); ?>" name="image_id">

                                <!-- Submit button for updating the image -->
                                <input type="submit" class="registreren-button" name="update" value="Wijzigen">
                            </form>
                        </div>
                    <?php 
                    } 
